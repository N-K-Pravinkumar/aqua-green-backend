...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        origins.add("https://aquagreenagencies.com");
        origins.add("https://www.aquagreenagencies.com");
        origins.add("https://admin.aquagreenagencies.com");
        origins.add("https://aqua-green-admin-frontend.vercel.app");
        origins.add("https://aqua-green-customer-frontend.vercel.app");
        origins.add("https://aqua-green-*.vercel.app");
