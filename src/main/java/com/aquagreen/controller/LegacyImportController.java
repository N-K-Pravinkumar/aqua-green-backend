 ...
 */
@RestController @RequestMapping("/api/service-requests/import") @RequiredArgsConstructor @Slf4j
            ...
            try {
                ...
                for (int i = 3; i < cols.length; i++) {
                    ...
                    if (cell.contains("/")) {
                        ...
                        } catch (NumberFormatException ignore) { /* not a "name / price" cell — skip it */ }
                    }
                }
